...
class AICModelsTest extends AnyFreeSpecLike with Matchers {
  ...
  "AIC Models" - {
    ...
    "should be able to create an image link from the AICSearchResponse and AICItemResult" in {
      val expectedItemLink = "https://www.artic.edu/iiif/2/5d3e12e4-bdf9-2dd6-6c6b-d3e1b7920edd/full/843,/0/default.jpg"
      val aic = AIC(itemResultExpectedResult)
      println(aic.createImageLink)
      aic.createImageLink shouldBe expectedItemLink
